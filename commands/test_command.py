...
def lock_command(inter: Interaction) -> None:
    ...
    allow = DiscordTypes.Permissions.SEND_MESSAGES | DiscordTypes.Permissions.MANAGE_THREADS
    allow_overwrite = PermissionOverwrite(channel.owner_id, 1, allow=int(allow), deny=0)
